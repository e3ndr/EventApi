...
public class EventHelper {
    ...
    public static MultiValuedMap<EventPriority, EventWrapper> wrap(Object listener) {
    ...
    public static boolean checkListenerExecution(Method method, AbstractEvent<?> event, EventListener annotation) {
